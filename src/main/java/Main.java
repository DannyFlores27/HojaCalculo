...
public class Main {
    public static void main(String[] args) {
        ...
        matriz.insertarCelda(11, 12, 20.5);
        ...
        // Realizar operaciones con la matriz cargada
        if (matrizCargada != null) {
            System.out.println(matrizCargada.realizarOperacion(11, 11, 11, 12, "sumar")); // 30.5
            System.out.println(matrizCargada.realizarOperacion(11, 11, 12, 11, "sumar")); // Error: Ambos valores deben ser numéricos
            System.out.println(matrizCargada.realizarOperacion(11, 11, 11, 12, "dividir")); // 0.4878048780487805
        }
    }
}
